...
import { ARK_BASE_URL, ARK_CREDENTIAL, ARK_SEEDREAM_MODEL, ARK_VISION_MODEL, SEEDREAM_MODEL_ALIASES, VOLCENGINE_TTS_CREDENTIAL, VOLCENGINE_TTS_RESOURCE, VOLCENGINE_TTS_URL, VOLCENGINE_TTS_VOICE, } from "./defaults.js";
export { ARK_BASE_URL, ARK_CREDENTIAL, ARK_SEEDREAM_MODEL, ARK_VISION_MODEL, SEEDREAM_MODEL_ALIASES, VOLCENGINE_TTS_CREDENTIAL, VOLCENGINE_TTS_RESOURCE, VOLCENGINE_TTS_URL, VOLCENGINE_TTS_VOICE, } from "./defaults.js";
...
export function resolveConfig(config = {}) {
    ...
    try {
        ...
        throw new VisionToolkitError('config', `provider.credential "${provider.credential ?? ARK_CREDENTIAL}" is not a valid credential reference`, { cause: error });
    }
    ...
    try {
        ...
        throw new VisionToolkitError('config', `provider.tts.credential "${tts.credential ?? VOLCENGINE_TTS_CREDENTIAL}" is not a valid credential reference`, { cause: error });
    }
