...
export const ARK_SKILLS_RESOURCE_BASE = fileURLToPath(new URL('../assets/skill/', import.meta.url));
/** Exact bundled instructions used as the progressive-exposure evidence marker. */
export const ARK_SKILLS_CONTENT = readFileSync(new URL('../assets/skill/SKILL.md', import.meta.url), 'utf8');
/** Runtime skill registration mounted only after every native tool is ready. */
export const ARK_SKILLS_SKILL = {
