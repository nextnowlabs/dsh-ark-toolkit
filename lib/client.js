...
exports.DISPLAY_CONFIG_ROUTE = '/_dsh/ark-toolkit/display-config';
 ...
 */
function SettingsCard({ controller, t }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("li", { className: "dvt-plugin-card", "data-open": open || undefined, children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dvt-card-head", "aria-expanded": open, "aria-label": `${t(open ? 'collapse' : 'expand')}: ${t('settingsTitle')}`, onClick: () => { setOpen(value => !value); }, children: [(0, jsx_runtime_1.jsxs)("span", { className: "dvt-card-head-text", children: [(0, jsx_runtime_1.jsx)("strong", { children: t('settingsTitle') }), (0, jsx_runtime_1.jsx)("small", { children: t('settingsIntro') })] }), status === undefined ? null : (0, jsx_runtime_1.jsx)("span", { className: "dvt-card-pill", "data-status": status.tone, children: status.label }), (0, jsx_runtime_1.jsx)("span", { className: "dvt-card-chevron", "aria-hidden": "true", children: "\u2304" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dvt-card-body", hidden: !open, children: (0, jsx_runtime_1.jsx)(LoadedSettings, { controller: controller, t: t }) })] }));
}
...
function apply(ctx) {
    ...
    ctx.effect(model_variants_hider_ts_1.installModelVariantsHider, 'dsh-ark-toolkit: model-selector transparent routing');
...
exports.PASTE_IMAGES_ROUTE = '/_dsh/ark-toolkit/paste-images';
exports.PASTE_POLICY_ROUTE = '/_dsh/ark-toolkit/paste-policy';
const MAX_IMAGES = 20;
...
function installPasteImages(ctx) {
    ...
    ctx.inject(['inputTriggers'], (scope) => {
        scope.effect(() => scope.inputTriggers.registerSource(controller.source()), 'dsh-ark-toolkit: pasted image reference codec');
    });
    ctx.effect(() => {
